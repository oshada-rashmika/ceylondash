...
class DatabaseService {
  ...
  Stream<List<OrderModel>> streamSellerOrders(String sellerId) {
    final mockData = [
      OrderModel(
        id: 'WBL-ASILA-001',
        orderName: 'Gadget Pack 1',
        externalPlatformRef: 'WB-001',
        sellerId: sellerId,
        customerId: 'cust_01',
        courierId: 'cour_01',
        status: 'pickup_scheduled',
        dropoffLocation: const GeoPoint(6.9271, 79.8612),
        dropoffAddress: 'No 12, Galle Road, Colombo 03',
        verification: {},
        timestamps: {'createdAt': Timestamp.now(), 'updatedAt': Timestamp.now()},
        rawData: {'customerName': 'Amal Perera', 'codAmount': 2500.0, 'totalAmount': 2500.0},
      ),
      OrderModel(
        id: 'WBL-ASILA-002',
        orderName: 'Tech Accessories',
        externalPlatformRef: 'WB-002',
        sellerId: sellerId,
        customerId: 'cust_02',
        courierId: 'cour_01',
        status: 'in_transit',
        dropoffLocation: const GeoPoint(6.9271, 79.8612),
        dropoffAddress: '45, Kandy Road, Peliyagoda',
        verification: {},
        timestamps: {'createdAt': Timestamp.now(), 'updatedAt': Timestamp.now()},
        rawData: {'customerName': 'Nimal Siripala', 'codAmount': 4200.0, 'totalAmount': 4200.0},
      ),
      OrderModel(
        id: 'WBL-ASILA-003',
        orderName: 'Smart Watch',
        externalPlatformRef: 'WB-003',
        sellerId: sellerId,
        customerId: 'cust_03',
        courierId: 'cour_01',
        status: 'delivered',
        dropoffLocation: const GeoPoint(6.9271, 79.8612),
        dropoffAddress: 'No 7, Temple Road, Nugegoda',
        verification: {},
        timestamps: {'createdAt': Timestamp.now(), 'updatedAt': Timestamp.now()},
        rawData: {'customerName': 'Kasun Silva', 'codAmount': 8500.0, 'totalAmount': 8500.0},
      ),
      OrderModel(
        id: 'WBL-ASILA-004',
        orderName: 'Wireless Earbuds',
        externalPlatformRef: 'WB-004',
        sellerId: sellerId,
        customerId: 'cust_04',
        courierId: 'cour_01',
        status: 'returned',
        dropoffLocation: const GeoPoint(6.9271, 79.8612),
        dropoffAddress: '88, Beach Road, Mount Lavinia',
        verification: {},
        timestamps: {'createdAt': Timestamp.now(), 'updatedAt': Timestamp.now()},
        rawData: {'customerName': 'Saman Kumara', 'codAmount': 3400.0, 'totalAmount': 3400.0},
      ),
      OrderModel(
        id: 'WBL-ASILA-005',
        orderName: 'Gaming Mouse',
        externalPlatformRef: 'WB-005',
        sellerId: sellerId,
        customerId: 'cust_05',
        courierId: 'cour_01',
        status: 'out_for_delivery',
        dropoffLocation: const GeoPoint(6.9271, 79.8612),
        dropoffAddress: '15, Lotus Road, Colombo 01',
        verification: {},
        timestamps: {'createdAt': Timestamp.now(), 'updatedAt': Timestamp.now()},
        rawData: {'customerName': 'Nuwan Pradeep', 'codAmount': 6000.0, 'totalAmount': 6000.0},
      ),
      OrderModel(
        id: 'WBL-ASILA-006',
        orderName: 'Mechanical Keyboard',
        externalPlatformRef: 'WB-006',
        sellerId: sellerId,
        customerId: 'cust_06',
        courierId: 'cour_01',
        status: 'delivered',
        dropoffLocation: const GeoPoint(6.9271, 79.8612),
        dropoffAddress: 'No 3, Park Rd, Narahenpita',
        verification: {},
        timestamps: {'createdAt': Timestamp.now(), 'updatedAt': Timestamp.now()},
        rawData: {'customerName': 'Dilshan Fernando', 'codAmount': 0.0, 'totalAmount': 10500.0},
      ),
      OrderModel(
        id: 'WBL-ASILA-007',
        orderName: 'Ergonomic Mousepad',
        externalPlatformRef: 'WB-007',
        sellerId: sellerId,
        customerId: 'cust_07',
        courierId: 'cour_01',
        status: 'delivered',
        dropoffLocation: const GeoPoint(6.9271, 79.8612),
        dropoffAddress: '10, Baseline Rd, Borella',
        verification: {},
        timestamps: {'createdAt': Timestamp.now(), 'updatedAt': Timestamp.now()},
        rawData: {'customerName': 'Malithi Silva', 'codAmount': 1200.0, 'totalAmount': 1200.0},
      ),
      OrderModel(
        id: 'WBL-ASILA-008',
        orderName: 'USB-C Docking Station',
        externalPlatformRef: 'WB-008',
        sellerId: sellerId,
        customerId: 'cust_08',
        courierId: 'cour_01',
        status: 'in_transit',
        dropoffLocation: const GeoPoint(6.9271, 79.8612),
        dropoffAddress: '24, Marine Drive, Kollupitiya',
        verification: {},
        timestamps: {'createdAt': Timestamp.now(), 'updatedAt': Timestamp.now()},
        rawData: {'customerName': 'Rohan Gunaratne', 'codAmount': 8500.0, 'totalAmount': 8500.0},
      ),
      OrderModel(
        id: 'WBL-ASILA-009',
        orderName: 'Noise Cancelling Headphones',
        externalPlatformRef: 'WB-009',
        sellerId: sellerId,
        customerId: 'cust_09',
        courierId: 'cour_01',
        status: 'in_transit',
        dropoffLocation: const GeoPoint(6.9271, 79.8612),
        dropoffAddress: 'No 1, Lake View, Battaramulla',
        verification: {},
        timestamps: {'createdAt': Timestamp.now(), 'updatedAt': Timestamp.now()},
        rawData: {'customerName': 'Sanduni Perera', 'codAmount': 15000.0, 'totalAmount': 15000.0},
      ),
    ];
